...
public class Bolum2Canvas1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {   
            ...
            {
                xpozisyon = Random.Range(219,272);
                zpozisyon = Random.Range(9, 24);
            }
            ...
            GameObject nesne = Instantiate(ClonZombiler1[zombÝndis], new Vector3(xpozisyon, 182, zpozisyon), randomRotation);
            nesnesayisi++;
        }
